...
#define ERR_DB2NSF_DAV_NOENCRYPT		PKG_DB2NSF+6
	errortext(ERR_DB2NSF_DAV_NOENCRYPT,	"Document contains encrypted field data and cannot be updated using SQL.")
#define ERR_DB2NSF_DAV_NOENCRYPT_DESIGN	PKG_DB2NSF+7
	errortext(ERR_DB2NSF_DAV_NOENCRYPT_DESIGN,	"Definition contains field(s) which are marked as encrypted in one or more of the selected forms.  Encrypted fields cannot be used with access views.")
...
#define ERR_DB2NSF_IMAP_NOT_SUPPORTED   PKG_DB2NSF+26
	apitext( ERR_DB2NSF_IMAP_NOT_SUPPORTED, "IMAP is not supported for DB2-based databases.")
...
#define ERR_DB2NSF_INIT_FAILURE	        PKG_DB2NSF+30
	apitext( ERR_DB2NSF_INIT_FAILURE,   "Unable to initialize DB2 services.  DB2-based NSF databases will be unusable." )
#define ERR_DB2NSF_TASKTRACK    	    PKG_DB2NSF+31
	errortext(ERR_DB2NSF_TASKTRACK,		"DB2 task tracking subsystem failure")
#define ERR_DB2NSF_TASKTRACK_FAIL       PKG_DB2NSF+32
	errortext(ERR_DB2NSF_TASKTRACK_FAIL, "Not all DB2 tasks could be interrupted")
#define ERR_DB2NSF_SPECIAL_FIELD_ERR	PKG_DB2NSF+33
	errortext(ERR_DB2NSF_SPECIAL_FIELD_ERR, "Field names beginning with '#' are reserved for Notes special fields - error in field : ")
#define ERR_DB2NSF_BAD_NAME		PKG_DB2NSF+34	
	errortext(ERR_DB2NSF_BAD_NAME,	"The DB2 Access View name or the DB2 column name is invalid.")
#define ERR_DB2NSF_QV_MAX_ROWS	PKG_DB2NSF+35   /* Hannover LI 3924.01 DB2 QV MAx Row message for more results */
	errortext(ERR_DB2NSF_QV_MAX_ROWS, "Warning: The Query View row limit has been exceeded and the results truncated")

/* Error codes from the XML mapping file starting with 0x3B2F*/
#define ERR_DB2NSF_REBALANCE            PKG_DB2NSF+47
	errortext(ERR_DB2NSF_REBALANCE,     "Container operations cannot be performed while a rebalance of the table space is pending or in progress.")			
...
#define  ERR_DB2NSF_PREREQ_STATE		PKG_DB2NSF+83
	errortext(ERR_DB2NSF_PREREQ_STATE,	"DB2-Object not in prerequisite state.  See the Domino server console for additional information.")
...
#define  ERR_DB2NSF_ENABLED				PKG_DB2NSF+91
	stringtext(ERR_DB2NSF_ENABLED, 		"DB2 Server:|Not Enabled|Enabled|DB2 Access:|Enabling Compression for %s.%s|Total disk space %s bytes, actual used %s bytes (%s%s)|Notes database|Total")
#define IDX_DB2_ENABLED_SERVER			1
#define IDX_DB2_ENABLED_NOT_EN			2
#define IDX_DB2_ENABLED_EN				3
#define IDX_DB2_ENABLED_ACCESS			4
#define IDX_DB2_ENABLED_COMPRESSION		5
#define IDX_DB2_SIZE_TOTAL_DISK			6
#define IDX_DB2_SIZE_NOTESDB			7
#define IDX_DB2_SIZE_TOTAL				8
...
#define IDX_DB2_ENABLE_LOG				1
#define IDX_DB2_SIZEINFO				2
#define IDX_DB2_CONTAINERNAME			3
#define IDX_DB2_RUNSTATS				4
#define IDX_DB2_NOTESDBSIZ				5
#define IDX_DB2_MISC_NAME				6
#define IDX_DB2_MISC_TOTAL				7
#define IDX_DB2_MISC_DATA				8
#define IDX_DB2_MISC_INDEX				9
#define IDX_DB2_MISC_LOB				10
#define IDX_DB2_MISC_TYPE				11
#define IDX_DB2_MISC_SCHEMA				12
#define IDX_DB2_MISC_TABLENAME			13


#define  ERR_DB2NSF_ENABLE_STATE		PKG_DB2NSF+95
	errortext(ERR_DB2NSF_ENABLE_STATE,	"Server doc update|Notes.ini update|Server id update|Catalog node|Load DB2 Library|Create user account|Add DB2DOM group to SYSCTRL_GROUP|Send server doc update request to Admin Process|Group %s %d of %d tables compressed")
...
#define IDX_DB2_ENABLE_COMPRESS_RESULTS 9
...
#define ERR_DB2NSF_XACL_NOT_SUPPORTED	PKG_DB2NSF+101
	errortext(ERR_DB2NSF_XACL_NOT_SUPPORTED,	"Extended ACL is not supported for DB2-based NSF databases." )
...
#define ERR_DB2NSF_WRONGSCHEMA			PKG_DB2NSF+108
	errortext(ERR_DB2NSF_WRONGSCHEMA,	"DB2 Database has the incorrect schema and cannot be used by this server." )
...
#define ERR_DB2NSF_DB2_CFG_SET		    PKG_DB2NSF+113
	errortext(ERR_DB2NSF_DB2_CFG_SET,   "Error setting configuration parameters for DB2 database." )
#define ERR_DB2NSF_FORMAT				PKG_DB2NSF+114
	errortext(ERR_DB2NSF_FORMAT,		"%s  %s  %s: %s - %s - %s(%s)" )
#define ERR_DB2NSF_DAVVERSION			PKG_DB2NSF+115
	errortext(ERR_DB2NSF_DAVVERSION,	"DB2 Access View definition has the wrong version for this program." )

/* there may be some available PKG_DB2NSF offsets above... */
/* this is the *current* max; PKG_DB2NSF offsets range from 0 to 255 */
#define ERR_DB2NSF_MAX				PKG_DB2NSF+116
...
#define ERR_COMPUTE_COMPILE_NOMEM	PKG_FORMULA+110
     errortext(ERR_COMPUTE_COMPILE_NOMEM, "Compiled formula exceeds limit of 64K.  Reduce size of formula.")
#define ERR_COMPUTE_NO_PREF			PKG_FORMULA+111
	errortext(ERR_COMPUTE_NO_PREF, "Specified view preference is unavailable")
...
#define ERR_NO_FILE_SHARING	PKG_NSF+13
	errortext(ERR_NO_FILE_SHARING,	"This database is currently in use by another person or process, and cannot be accessed at this time.  In order to share a Notes database, it must be accessed via a Domino Server by all users of the database.")
...
#define	ERR_TOOHUGE			PKG_NSF+51
	errortext(ERR_TOOHUGE,	"Object too large to allocate given file parameters")
...
#define ERR_FOLDER_TIMEDATE_FDOENTRY	PKG_NSF+152
	errortext(ERR_FOLDER_TIMEDATE_FDOENTRY,	"Error reading FolderModified time in database %p. Run fixup on the database.")
#define ERR_FOLDER_TIMEDATE_OPTIME		PKG_NSF+153
	errortext(ERR_FOLDER_TIMEDATE_OPTIME,	"Error reading OperationTime for folder operations in database %p. Run fixup on the database.")
#define ERR_FOLDER_TIMEDATE_FOENTRY		PKG_NSF+154
	errortext(ERR_FOLDER_TIMEDATE_FOENTRY,	"Error reading FolderModified time from header in database %p. Run fixup on the database.")
#define ERR_FOLDER_TIMEDATE_REORG		PKG_NSF+155
	errortext(ERR_FOLDER_TIMEDATE_REORG,	"Error reading RevisionTime for folder operations in database %p. Run fixup on the database.")
...
#define	ERR_NSF_COMPACT_DOCUMENTS 		PKG_NSF+160
	errortext(ERR_NSF_COMPACT_DOCUMENTS,	"Unable to compress documents, database must be upgraded to R8 or later database version")
...
#define ERR_CORRUPT_ACL			PKG_NSF+162
	stringtext(ERR_CORRUPT_ACL,	"ACL Corrupt in database %s, creating new ACL with default set to no access.")
#define ERR_CREATING_ACL			PKG_NSF+163
	stringtext(ERR_CREATING_ACL,	"Error creating ACL, returning error no access.")
/* Available PKG_NSF+164 */
...
#define NSFSTR_COMPACT_PROGRESS_MSGS	PKG_NSF+168
	stringtext(NSFSTR_COMPACT_PROGRESS_MSGS, "Compacting database|Encrypting database|Decrypting database")
#define NSFSTR_COMPACT_PROGRESS	1
#define NSFSTR_ENCRYPT_PROGRESS	2
#define NSFSTR_DECRYPT_PROGRESS	3
...
#define	ERR_LOCALSEC_DBOPENFAILURE		PKG_NSF+248
	errortext(ERR_LOCALSEC_DBOPENFAILURE,	"This database has local access protection (encrypted) and you are not authorized to access it")
...
#define NSFSTR_FOUND_SUMMARY_TOO_LARGE	PKG_NSF2+65
	stringtext(NSFSTR_FOUND_SUMMARY_TOO_LARGE, "WARNING: One or more documents in %p were not added to the search results because of the amount of summary data.")
#define NSFSTR_SUMMARY_TOO_LARGE_DETAIL	PKG_NSF2+66
	stringtext(NSFSTR_SUMMARY_TOO_LARGE_DETAIL, "WARNING: Note 0x%X was not added to the search results for %p because its summary data (%d) is greater than allowed (%d).")
...
#define ERR_NOTE_LOCKED					PKG_NSF3+125
	errortext(ERR_NOTE_LOCKED,			"The document is already locked by %a")
...
#define ERR_CMD_SHOW_NSFPOOL			PKG_NSF5+10
	stringtext(ERR_CMD_SHOW_NSFPOOL,	 "NSFPOOL [headers]")
...
*/
#define ERR_NSF_PROFDOCCACHE_POOLFULL		PKG_NSF8+5
	errortext(ERR_NSF_PROFDOCCACHE_POOLFULL, "Insufficient memory - NSF profile doccache accessors pool is full.")
...
#define STR_ROAMING_USER_ACCESS				PKG_NSF8+86
	errortext(STR_ROAMING_USER_ACCESS,		"Roaming user %a password failed")
...
#define ERR_INVALID_NSF_CIPHER_CTX			PKG_NSF9+31
	errortext(ERR_INVALID_NSF_CIPHER_CTX,	"Invalid NSF cipher context.")
...
#define ERR_DB2_PASSWORD_UPDATE_FAILED			PKG_NSF9+94
	errortext(ERR_DB2_PASSWORD_UPDATE_FAILED, 	"The DB2 password update failed: %s.")

#define ERR_NSF_INVALID_PROVISIONING_URL		PKG_NSF9+95
	errortext(ERR_NSF_INVALID_PROVISIONING_URL, "The provisioning URL is invalid = %s")

#define ERR_DB2_UPDATE_OS_PW					PKG_NSF9+96
	errortext(ERR_DB2_UPDATE_OS_PW, 			"Error while updating the DB2 password.")

#define ERR_DB2_PASSWORD_UPDATE_NOT_SUP			PKG_NSF9+97
	errortext(ERR_DB2_PASSWORD_UPDATE_NOT_SUP, 	"The DB2 password update is not supported by this system.")

#define ERR_DB2_OLD_ID_PW_VER					PKG_NSF9+98
	errortext(ERR_DB2_OLD_ID_PW_VER, 			"Please update the server to the latest V8 version.")
#define ERR_FILE_NOT_REDIRECT					PKG_NSF9+99
	errortext(ERR_FILE_NOT_REDIRECT,			"File is not a redirect")
...
#define ERR_NSF_REDIRECT_EXISTS					PKG_NSF9+107
	errortext(ERR_NSF_REDIRECT_EXISTS,			"A redirect exists for this database")
...
#define ERR_DB2NSF_NOTDB2BACKED					PKG_NSF9+113
	errortext(ERR_DB2NSF_NOTDB2BACKED,          "Not a DB2 backed database.")
...
#define ERR_ARCHIVE_BAD_PROFILE				PKG_NSF9+118
	errortext(ERR_ARCHIVE_BAD_PROFILE,		"ARCHIVE:  Archive Profile Document for database %p is problematic and must be deleted.")

#define ERR_CMD_DB2_ACCESS_ID_NAME			PKG_NSF9+119
	errortext(ERR_CMD_DB2_ACCESS_ID_NAME,	"DB2 Access Name (%a), does not match DB2 Access Name in server document (%a).")
#define CONTEXT_DB2NSF_ERRORS			PKG_NSF9+120
	errortext(CONTEXT_DB2NSF_ERRORS,	"Error updating persisted errors table (DOMINO.ERRORS)")

#define ERR_DB2_CONT_PATH			PKG_NSF9+121
	errortext(ERR_DB2_CONT_PATH,	"Error updating the directory field on the DB2 tab of the server document. Please update the filed with the new directory.")

#define ERR_USER_NAME_TOO_LONG				PKG_NSF9+122
	errortext(ERR_USER_NAME_TOO_LONG,		"User name exceeds maximum size, Access denied to DB %p ")

#define ERR_DB2_UPDATE_USER_ENTRY			PKG_NSF9+123
	errortext(ERR_DB2_UPDATE_USER_ENTRY,	"Error updating DB2 Access entry in server document.")
...
#define ERR_DB2_UDF_ADMIN_DLL_RET				PKG_NSF9+126
	stringtext(ERR_DB2_UDF_ADMIN_DLL_RET,		"%d UDF Admin DLL: %s.|Update connection completed|Update connection returned error|Read connection returned error|Admin command could not be parsed (Command sent = %s).")
...
#define IDX_DB2_UDF_DLL_PARSE_ERR	5
...
#define ERR_DB2_BACKLEVEL				    PKG_NSF9+177
	errortext(ERR_DB2_BACKLEVEL,		"WARNING: DB2 version does not meet the minimum to enable this feature. Upgrade your DB2 installation.")
...
#define STR_UDF_SETUP_COMPLETE				PKG_NSF9+181
	errortext(STR_UDF_SETUP_COMPLETE,		"DB2 Access setup complete." )
...
#define ERR_SINGLEVAL_CONSTRAINT			PKG_NSF9+191
	errortext(ERR_SINGLEVAL_CONSTRAINT,		"Cannot save a multi-value item to a DB2 Access column defined as 'single value only'.")
...
#define ERR_DAV_NOFIELDS					PKG_NSF9+195
	errortext(ERR_DAV_NOFIELDS,				"Access View Definition must contain at least one stored field.")
...
#define IDX_DB2_ACCESS_SETUP_DOC	1
#define IDX_DB2_ACCESS_SETUP_INI	2
...
#define ERR_UDF_PASSWORD					PKG_NSF9+221
	errortext(ERR_UDF_PASSWORD,				"DB2 Access Server ID must not contain a password.")
...
#define ERR_UDF_TIMEOUT						PKG_NSF9+227
	errortext(ERR_UDF_TIMEOUT,				"Lost contact with server.")
#define ERR_UDF_TIMEOUT_WITH_COMMIT			PKG_NSF9+228
	errortext(ERR_UDF_TIMEOUT_WITH_COMMIT,	"Lost contact with server while operation was committing.")
...
#define STR_DB2_GROUP_SETSTATE				PKG_DB2_STR+0
	stringtext(STR_DB2_GROUP_SETSTATE,		"unlocked|locked|%s has been %s.|%s could not be %s.|Group %s does not exist.|Group %s is already %s.")
...
#define STR_DB2_GROUP_DEFAULT				PKG_DB2_STR+37
	stringtext(STR_DB2_GROUP_DEFAULT,		"Default|no specific DB2 mapping, using default Query View user|No specific user or Default Query View user mapping available|mapped to specific DB2 user|user not found, using default Query View user")
#define STR_DB2_GROUP_DEFAULT_IDX		1
#define STR_DB2_GROUP_DEFQRYVIEW_IDX	2
#define STR_DB2_GROUP_NOAUTH			3
#define STR_DB2_GROUP_SPECIFICAUTH		4
#define STR_DB2_GROUP_DEFAULT_NOUSER	5
...
#define STR_DB2NSF_DBCFG_UPDATE		    PKG_DB2_STR+49
    stringtext(STR_DB2NSF_DBCFG_UPDATE, "Updating DB2 database configuration parameters for optimization...")
...
#define STR_DB2_REORG_SQLCA     PKG_DB2_STR+52
	stringtext(STR_DB2_REORG_SQLCA, "Reorg error on table %s: %s")
#define STR_DB2_ACCESS_SET_STEPS	PKG_DB2_STR+53
    stringtext(STR_DB2_ACCESS_SET_STEPS,"DB2 Access Set: %s|Updating notes.ini|Updating server document.|Dropping deprecated functions.|Adding new functions.|Adding connection document.|Testing connection from DB2 Access.|Failed.")
#define IDX_DB2_ACCESS_STEP_SET				1
#define IDX_DB2_ACCESS_STEP_UPDT_NOTES_INI	2
#define IDX_DB2_ACCESS_STEP_UPDT_SRV_DOC	3
#define IDX_DB2_ACCESS_STEP_DROP_FUNC		4
#define IDX_DB2_ACCESS_STEP_ADD_FUNC    	5
#define IDX_DB2_ACCESS_STEP_ADD_CONN   		6
#define IDX_DB2_ACCESS_STEP_TEST_CONN 		7
#define IDX_DB2_ACCESS_STEP_FAILED 			8
#define STR_UDF_REMOVE_WARNING1			PKG_DB2_STR+54
	errortext(STR_UDF_REMOVE_WARNING1,		"Warning: 'DB2 Access Remove' failed to remove the DB2 Access fields/parameters from the server document or the notes.ini. Please retry or clear the 'DB2 Access server' and 'DB2 Access path' fields in the server document." )
#define STR_DB2_DEF_QRY_ERR     PKG_DB2_STR+55
	stringtext(STR_DB2_DEF_QRY_ERR, "Domino server's DB2 id cannot be used as the default query view user DB2 id, ignoring default query view user.")
#define STR_UDF_SETUP_MISSING_TRUSTSRV			PKG_DB2_STR+56
	errortext(STR_UDF_SETUP_MISSING_TRUSTSRV,	"DB2 Access server, %a, is missing from item '%s' in %s." )
#define STR_UDF_SETUP_FOUND_TRUSTSRV			PKG_DB2_STR+57
	errortext(STR_UDF_SETUP_FOUND_TRUSTSRV,		"DB2 Access server, %a, was found in item '%s' in %s." )
#define STR_UDF_TEST_ITEMS						PKG_DB2_STR+58
	errortext(STR_UDF_TEST_ITEMS,				"DB2 Access Server|DB2 Access Path")
#define DB2STR_UDF_SET_ERR						PKG_DB2_STR+59
	errortext(DB2STR_UDF_SET_ERR,				"DB2NSFInit Error Checking/Updating UDF Version.")
#define IDX_DB2_ACCESS_TEST_SERVER		1
#define IDX_DB2_ACCESS_TEST_PATH		2
#define STR_UDF_REMOVE_WARNING_DONE				PKG_DB2_STR+60
	errortext(STR_UDF_REMOVE_WARNING_DONE,		"DB2 Access remove has completed with warnings." )
#define STR_DB2_COMPACT_IGNORE_NSF      PKG_DB2_STR+61
	stringtext(STR_DB2_COMPACT_IGNORE_NSF, "Compacting NSFDB2 databases only, ignoring NSF database %s")

#define IDX_DB2_PW_1				1
#define IDX_DB2_PW_2				2
#define IDX_DB2_PW_3				3
#define IDX_DB2_PW_4				4
#define IDX_DB2_PW_5				5
#define IDX_DB2_PW_6				6
#define IDX_DB2_PW_7				7
#define IDX_DB2_PW_14				14
#define IDX_DB2_PW_15				15
#define IDX_DB2_PW_17				17
#define IDX_DB2_PW_19				19
#define IDX_DB2_PW_24				24

#define STR_DB2_PASSWORD_1	PKG_DB2_STR+62 
	stringtext(STR_DB2_PASSWORD_1, "%s: The old password specified in the request is not valid.")

#define STR_DB2_PASSWORD_2	PKG_DB2_STR+63 
	stringtext(STR_DB2_PASSWORD_2, "%s: The password specified in the request is not valid under the password rules imposed by the system where password was to be changed.")

#define STR_DB2_PASSWORD_3	PKG_DB2_STR+64 
	stringtext(STR_DB2_PASSWORD_3, "%s: The request did not include an old password.")

#define STR_DB2_PASSWORD_4	PKG_DB2_STR+65 
	stringtext(STR_DB2_PASSWORD_4, "%s: The request did not include a new password.")

#define STR_DB2_PASSWORD_5	PKG_DB2_STR+66 
	stringtext(STR_DB2_PASSWORD_5, "%s: The request did not include a userid.")

#define STR_DB2_PASSWORD_6	PKG_DB2_STR+67 
	stringtext(STR_DB2_PASSWORD_6, "%s: The userid specified in the request is not valid.")

#define STR_DB2_PASSWORD_7	PKG_DB2_STR+68 
	stringtext(STR_DB2_PASSWORD_7, "%s: The userid specified in the request has been revoked. Passwords can not be changed for revoked userids.")

#define STR_DB2_PASSWORD_14	PKG_DB2_STR+69 
	stringtext(STR_DB2_PASSWORD_14, "%s: The installation security exit failed.")

#define STR_DB2_PASSWORD_15	PKG_DB2_STR+71 
	stringtext(STR_DB2_PASSWORD_15, "%s: Security processing at the server failed.")

#define STR_DB2_PASSWORD_17	PKG_DB2_STR+72 
	stringtext(STR_DB2_PASSWORD_17, "%s: Change password function is not supported by the system.")

#define STR_DB2_PASSWORD_19	PKG_DB2_STR+73 
	stringtext(STR_DB2_PASSWORD_19, "%s: The userid has been disabled, or the userid has been restricted from accessing the operating environment at this time.")

#define STR_DB2_PASSWORD_24	PKG_DB2_STR+74 
	stringtext(STR_DB2_PASSWORD_24, "%s: The username specified, password specified, or both, are invalid.")

#define STR_DB2_PASSWORD_0	PKG_DB2_STR+75 
	stringtext(STR_DB2_PASSWORD_0, "Not Specified: The specific security error is not specified.")

#define STR_DB2_NODE_INFO_PROT			PKG_DB2_STR+76 
	stringtext(STR_DB2_NODE_INFO_PROT, 	"The node name you have specified exists but is using a protocol that is not supported by DOMINO.\nPlease use another node name.\n")

#define STR_DB2_NODE_INFO_HOST			PKG_DB2_STR+77 
	stringtext(STR_DB2_NODE_INFO_HOST, 	"The node name you have specified exists but does not connect to the host specified (%s). It connects to %s. Please correct the host name.\n")

#define STR_DB2_NODE_INFO_PORT			PKG_DB2_STR+78 
	stringtext(STR_DB2_NODE_INFO_PORT, 	"The node name you have specified exists but is not using the port/service-name specified (%s). It uses %s. Please correct the port/service-name.\n")


#define STR_DB2_CONT_REQ_SUBMITTED_LOG			   	PKG_DB2_STR+79
	stringtext(STR_DB2_CONT_REQ_SUBMITTED_LOG,   	"The DB2 container move request has been submitted to and is being processed by the DB2 server." )

#define STR_DB2_CONT_REQ_FAILED_LOG			   		PKG_DB2_STR+80
	stringtext(STR_DB2_CONT_REQ_FAILED_LOG,   		"The DB2 container move request could not be submitted to the DB2 server. Request failed with error - %e." )

#define STR_DB2_ACCESS_PREV_ENABLED			   		PKG_DB2_STR+81
	stringtext(STR_DB2_ACCESS_PREV_ENABLED,   		"DB2 Access was previously enabled on this server." )

#define STR_DB2_NODE_CONN_ERROR			   			PKG_DB2_STR+82
	stringtext(STR_DB2_NODE_CONN_ERROR,   			"The Domino server failed trying to connect to the DB2 node. \nPlease check the node informatiion. \nDrop the node by doing:\nDB2STOP\nDROP NODE <NodeName>\nDB2START\n" )
