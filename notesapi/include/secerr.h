...
#define ERR_SECURE_NT_SETPASSWORD		PKG_SECURE+84
	errortext(ERR_SECURE_NT_SETPASSWORD, "Unable to execute your Windows password change")
...
#define STR_TRACE_ENCRYPTIONON			PKG_SECURE2+12
	stringtext(STR_TRACE_ENCRYPTIONON,	"Encryption is Enabled")

#define STR_TRACE_ENCRYPTIONOFF			PKG_SECURE2+13
	stringtext(STR_TRACE_ENCRYPTIONOFF,	"Encryption is Disabled")

#define STR_TRACE_COMPRESSIONON			PKG_SECURE2+14
	stringtext(STR_TRACE_COMPRESSIONON,	"Compression is Enabled")

#define STR_TRACE_COMPRESSIONOFF		PKG_SECURE2+15
	stringtext(STR_TRACE_COMPRESSIONOFF,	"Compression is Disabled")
