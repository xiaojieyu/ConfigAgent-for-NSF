...
#define SIG_CD_PDEF_MAIN		(83 | WORDRECORDLENGTH ) /* Signatures for items used in Property Broker definitions. LI 3925.04 */
#define SIG_CD_PDEF_TYPE		(84 | WORDRECORDLENGTH )
#define SIG_CD_PDEF_PROPERTY	(85 | WORDRECORDLENGTH )
#define SIG_CD_PDEF_ACTION		(86 | WORDRECORDLENGTH )
