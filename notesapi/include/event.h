...
#if defined(NT) || defined(SOLARIS) || defined(AIX) || defined(LINUX)
#define TEC_PLATFORM
#endif
...
STATUS LNPUBLIC EventQueueGet(char far *QueueName, DHANDLE far *rethEvent);
/*
...
BOOL LNPUBLIC EventGetDestNameEx(WORD EventType, WORD EventSeverity, char *ErrorCode, char *ErrorText, char *QueueName, 
									char *DestName, WORD DestNameSize);
...
#define	EVT_PROG		24
#define	MAX_TYPE		25
#define	EVT_ANY_TYPE	99  /* Any old type */
...
#define	PROG_NAME		"Programming"						   
#define	EVENT_NAME		"Event"
#define AMGR_NAME		"Amgr"
...
#define FIRST_SERVER_INI "FirstServerInDomain"
