...
typedef STATUS (LNCALLBACKPTR DBOPENBYIDPROC)(DBID ReplicaID, char far *FileTitle, DHANDLE hNames, DBHANDLE far *rethDB);
...
typedef struct dbvec
	...
	STATUS (LNCALLBACKPTR SetOpenContext)(struct dbvec far *vec, HDBDSESSION hSession, char far *DefaultDbName, DBOPENBYIDPROC Proc, DHANDLE hNames, DWORD hParentWnd);
	...
	STATUS (LNCALLBACKPTR Function)(struct dbvec far *vec, HDBDSESSION hSession,
							...
							DHANDLE far *rethResult, DWORD far *retResultLength);
