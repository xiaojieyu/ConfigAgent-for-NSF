...
#define ERR_BSAFE_NSL_UNLOCK_FAILED			(PKG_BSAFE+75)
	errortext (ERR_BSAFE_NSL_UNLOCK_FAILED,		"Single Login failed with this ID file")
...
#define ERR_BSAFE_FLAT_KEY_TOO_BIG			(PKG_BSAFE+99)
	errortext(ERR_BSAFE_FLAT_KEY_TOO_BIG,	"Exceeded RSA key size limit for a flat ID")
...
#define ERR_BSAFE_ID_EXTRA_TYPE			(PKG_BSAFE+109)
	errortext(ERR_BSAFE_ID_EXTRA_TYPE,	"Domino Controller|DB2|DB2 Default")
#define	ERR_BSAFE_VERSION_NOT_V8		(PKG_BSAFE+110)
	errortext(ERR_BSAFE_VERSION_NOT_V8,	"This extra item is only available on V8 servers.")
...
#define ERR_BSAFE_NO_PUBLIC_INFO			(PKG_BSAFE+113)
	errortext(ERR_BSAFE_NO_PUBLIC_INFO,		"Your public key was not found in the Domino Directory")
...
#define ERR_BSAFE_KEY_NEVER_ROLLED_OVER			(PKG_BSAFE+137)
	errortext(ERR_BSAFE_KEY_NEVER_ROLLED_OVER,	"This entity's keys have never been rolled over to a new set of keys")
...
#define ERR_BSAFE_OCSP_CERT_NOT_VERIFIED		(PKG_BSAFE4+3)
	errortext (ERR_BSAFE_OCSP_CERT_NOT_VERIFIED, "The revocation status of this certificate could not be verified")

#define ERR_BSAFE_ICC_UNKNOWN                   (PKG_BSAFE4+4)
	errortext (ERR_BSAFE_ICC_UNKNOWN,           "Unknown error received from ICC")
#define ERR_BSAFE_NSL_UNSUPPORTED_FUNC			(PKG_BSAFE4+5)
	stringtext	(ERR_BSAFE_NSL_UNSUPPORTED_FUNC, "This is not supported by Single Login-enabled notes id's.")
#define ERR_BSAFE_ICC_INIT_FAILED               (PKG_BSAFE4+6)
	stringtext  (ERR_BSAFE_ICC_INIT_FAILED,     "ICC library could not be found or initialization failed. Please check your configuration.")
...
#define ERR_BSAFE_NO_CROSS_CERT_NAMES 				(PKG_BSAFE4+31)
	errortext(ERR_BSAFE_NO_CROSS_CERT_NAMES,		"No cross certificate from %A to %A was found in the directory")
...
#define ERR_BSAFE_INCOMPAT_PUBLIC_KEY			(PKG_BSAFE5+11)
	errortext(ERR_BSAFE_INCOMPAT_PUBLIC_KEY,	"The recipient's Notes public key is not compatible with the configured encryption settings.")
...
#define ERR_BSAFE_INCOMPAT_SECRET_KEY			(PKG_BSAFE5+14)
	errortext(ERR_BSAFE_INCOMPAT_SECRET_KEY,	"The secret key is not compatible with the configured encryption settings.")
...
#define STR_BSAFE_EXTRA_DATA_TYPES		(PKG_BSAFE_STR+80)
	stringtext (STR_BSAFE_EXTRA_DATA_TYPES,		"DB2 user name|DB2 password|Server Controller user name|Server Controller password|Default DB2 user name|DB2 Password Expiration")
#define IDX_EXTRA_TYPE_DB2_USER			1
#define IDX_EXTRA_TYPE_DB2_PW			2
#define IDX_EXTRA_TYPE_SC_USER			3
#define IDX_EXTRA_TYPE_SC_PW			4
#define IDX_EXTRA_TYPE_DB2_DEF_USER		5
#define IDX_EXTRA_TYPE_DB2_PW_EXP		6
...
#define STR_BSAFE_OCSP_INVALID_NONCE            (PKG_BSAFE_STR+86)
	 stringtext (STR_BSAFE_OCSP_INVALID_NONCE,   "OCSP: Bad nonce received. A replay attack may be in progress")
#define STR_BSAFE_OCSP_NO_NONCE                 (PKG_BSAFE_STR+87)
	 stringtext (STR_BSAFE_OCSP_NO_NONCE,        "OCSP: WARNING: No nonce received. A replay attack may be in progress")
#define STR_BSAFE_OCSP_CERT_GOOD                (PKG_BSAFE_STR+88)
	 stringtext (STR_BSAFE_OCSP_CERT_GOOD,       "OCSP: Certificate %s is valid according to %s")
#define STR_BSAFE_OCSP_CERT_REVOKED             (PKG_BSAFE_STR+89)
	 stringtext (STR_BSAFE_OCSP_CERT_REVOKED,    "OCSP: Certificate %s was revoked on %s according to %s")
#define STR_BSAFE_OCSP_CERT_UNKNOWN             (PKG_BSAFE_STR+90)
	 stringtext (STR_BSAFE_OCSP_CERT_UNKNOWN,    "OCSP: The validity of certificate %s could not be determined by %s")
#define STR_BSAFE_OCSP_RESPONSE_TYPES           (PKG_BSAFE_STR+91)
	 stringtext (STR_BSAFE_OCSP_RESPONSE_TYPES,  "OCSP response status: %s|Malformed OCSP request|Internal error in OCSP responder|Try again later|Signature required|Request unauthorized|Invalid response (0x%02x) received|OCSP response corrupt")
#define IDX_OCSP_RESPONSE_BASE       1
#define IDX_OCSP_RESPONSE_MALFORMED  2
#define IDX_OCSP_RESPONSE_INTERNAL   3
#define IDX_OCSP_RESPONSE_TRYLATER   4
#define IDX_OCSP_RESPONSE_SIGREQ     5
#define IDX_OCSP_RESPONSE_UNAUTH     6
#define IDX_OCSP_RESPONSE_NOTUSED    7
#define IDX_OCSP_RESPONSE_CORRUPT    8

#define STR_BSAFE_OCSP_MISC                     (PKG_BSAFE_STR+92)
	 stringtext (STR_BSAFE_OCSP_MISC,            "OCSP:|Unable to contact OCSP responder at %.*s")
#define IDX_OCSP_MISC_OCSP           1
#define IDX_OCSP_MISC_NO_RESPONSE    2

#define STR_BSAFE_TEST_VECTOR_FAILED			(PKG_BSAFE_STR+93)
	 stringtext (STR_BSAFE_TEST_VECTOR_FAILED,	"Test failed for test vector number %d algorithm %s.")
#define STR_BSAFE_BULK_ALG						(PKG_BSAFE_STR+94)
	stringtext (STR_BSAFE_BULK_ALG,				"Compatible with all releases (64 Bit RC2)|Compatible with release 6 and later (128 Bit RC2)|Compatible with release 8 and later (128 Bit AES)|Compatible with release 8 and later (256 Bit AES)")
#define STR_BSAFE_BULK_ALG_ABBREV				(PKG_BSAFE_STR+95)
	stringtext (STR_BSAFE_BULK_ALG_ABBREV,		"64 Bit RC2|128 Bit RC2|128 Bit AES|256 Bit AES")
#define IDX_STR_BSAFE_BALG_RC2_64	1
#define IDX_STR_BSAFE_BALG_RC2_128	2
#define IDX_STR_BSAFE_BALG_AES_128	3
#define IDX_STR_BSAFE_BALG_AES_256	4
