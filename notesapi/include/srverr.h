...
#define STR_LUM_NO_PROD_LIC				PKG_SERVER6+37
	stringtext(STR_LUM_NO_PROD_LIC,		"IBM Lotus Domino does not have a production license.  A temporary evaluation license has been enrolled for you to use for 60 days.")
#define STR_LUM_EXP_LIC					PKG_SERVER6+38
	stringtext(STR_LUM_EXP_LIC,			"Your license is expired. You should install a production version of IBM Lotus Domino to continue using this product.")
