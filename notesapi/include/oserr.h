...
#define ERR_RTVSCAN_MEMORY		PKG_OS+21
	errortext(ERR_RTVSCAN_MEMORY,		"RTVSCAN is operational and may be holding our memory, exiting.  Please restart RTVSCAN or reboot the system")

/* 22 is free, in theory - it used to be an OS2 specific error code */
...
#define ERR_LEAK_TRACING_POOL_FULL	 	PKG_OS+164
	errortext(ERR_LEAK_TRACING_POOL_FULL,	"DEBUG_TRAPLEAKS: Could not add %s trace for %s because pool used for tracing is full. (%s=%s)")
...
#define ERR_LEAK_TRACING_DDM			PKG_OS+179
	errortext(ERR_LEAK_TRACING_DDM,	"DEBUG_TRAPLEAKS: %d outstanding allocations of block type 0x%04X")
#define STR_BYTES_KBYTES				PKG_OS+180
	stringtext(STR_BYTES_KBYTES,		"%ld bytes|%ldK bytes")
#define IDX_BYTES	1
#define IDX_KBYTES	2
...
#define STR_OS_KBYTES					PKG_OS+254
	stringtext (STR_OS_KBYTES,			"%ldK|%ldM|%ldG|%ldT|%sK|%sM|%sG|%sT")

#define IDX_K		1
#define IDX_M		2
#define IDX_G		3
#define IDX_T		4
#define IDX_BYTES_K	5
#define IDX_BYTES_M	6
#define IDX_BYTES_G	7
#define IDX_BYTES_T	8
