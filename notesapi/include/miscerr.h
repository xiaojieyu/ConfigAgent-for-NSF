...
#define ERR_NEWVIEWTYPE_OLDSERVER		(PKG_MISC+156)
	errortext(ERR_NEWVIEWTYPE_OLDSERVER,"This database is on a server running a previous version of Lotus Domino that does not support this type of view or folder.")
...
#define STR_IL_ERROR								(PKG_MISC3+26)
