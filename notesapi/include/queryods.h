...
#define ASSISTTRIGGER_TYPE_SERVERSTART		8	/*	On server start */
...
#define ASSISTSEARCH_TYPE_DEFAULT 0	/* Applies to new mail, new/mod and updated agents. Value overloaded, same as ASSISTSEARCH_TYPE_NONE used for manual agents.  */
