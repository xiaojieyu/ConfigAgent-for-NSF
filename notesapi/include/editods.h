...
#define TPL_FLAG_THEMESETTING		0x0180	/* 2 bits to reflect three possible settings. */
#define TPL_SHIFT_THEMESETTING		7	/* shift right this many bits to get the theme setting into the low-order bits. */
...
typedef struct {
	...
	WORD Flags;
#if defined(LITTLE_ENDIAN_ORDER) || defined(CONVERSION_UTILITY)
...
#define BARREC_POSTREPLYSECTION				0x8000L
...
#define	BARREC_BORDER_DUOCOLOR		10
...
#define BARREC_ODS_MASK 0xF4FFEFF7
...
#define BARREC_DATA_BORDER_DUOCOLOR		3

#define BARREC_DATA_REPLYSECTION	0x0000010L
...
#define EMBEDDEDOUTLINE_FLAG_MAINTAINFOLDERUNREAD	0x01000000
...
#define EMBEDDEDSCHED_FLAG_SHOW_CHECKBOXES			0x00080000
...
#define HTML_EVENT_CLIENT_SCHED_SUGGESTIONSAVAIL	0x122
#define HTML_EVENT_CLIENT_VIEW_ONSELECT	0x123	/* LI 3359.2 */
#define HTML_EVENT_CLIENT_VIEW_ONFOCUS	0x124	/* LI 6754.05 */
#define HTML_EVENT_CLIENT_VIEW_ONBLUR	0x125
...
#define	CD_TABLECELL_ELEMENT		131
...
/*	Needed a unique signature for table cell dataflags
 *	but can use the standard CDDATAFLAGS structure. */
