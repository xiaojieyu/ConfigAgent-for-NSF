...
#define FIELD_MAILSEND "$MailSend" /* Temp field so mailer will still send recoginize Notes created by AtMailSend regardless of user's ACL*/
...
#define ITEM_DIR_OBJECT_ID		"$$DirObjectId"	/* Unique identifier of a directory entry, returned
												 * from NAMELookup.  Good for Domino or LDAP backends.*/
...
#define DFLAGPAT_FORM "-FQMUGXWy#i:|@0nKg~%z^"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_FORM_MENUABLE "-FQMUGXWy#i:|@40nKg~%z^}"	/* display things showable on the menu */
#define DFLAGPAT_FORM_ALL_VERSIONS "-FQMUGXWy#i:|@Kg~%z^}" /* display things editable with dialog box; no version filtering (for design) */
#define DFLAGPAT_PRINTFORM_ALL_VERSIONS "+?" /* display things editable with dialog box; no version filtering (for design) */
#define DFLAGPAT_FIELD "-FQMUGXWy#i@0nKg~%z^"	/* display things editable with dialog box; version filtering (more complex than necessary,
													but trying to avoid any possible incompatibility vs. earlier use of DFLAGPAT_VIEWFORM) */
#define DFLAGPAT_FIELD_ALL_VERSIONS "-FQMUGXWy#i@Kg~%z^}" /* display things editable with dialog box; no version filtering (for design) */
...
#define DFLAGPAT_VIEW_MENUABLE "-FQMUGXWy#i@40nKg~%z^}"	/* display things showable on the menu */
#define DFLAGPAT_VIEW_ALL_VERSIONS "-FG^"		/* display only views (not folders, navigators or shared columns) */
...
#define DFLAGPAT_FILE_ELEMS		"(+gi|=-/*"	/* files plus images plus comp app plus style sheets with no directory elements */
...
#define DFLAGPAT_COMPDEF	"+:"		/* Wiring Properties element is a Form note. LI 3925.05 */
#define DFLAGPAT_COMPAPP	"+|"		/* Composite Application element is a Form note. LI 3925.04 */

/* Web server patterns */
#define DFLAGPAT_NONWEB "+w80stVXp^"			/* elements that are never used on the web */
#define DFLAGPAT_NONWEB_EXCLUDE "-w80stVXp^"	/* same flags as DFLAGPAT_NONWEB */
...
#define DESIGN_FLAGEXT_WEBSERVICELIB			'W' /* 	Scriptlib is a web service consumer lib*/
...
#define DOCUMENT_ABSTRACT_ITEM "$Abstract"		/* Document Abstract text item name */

/* Anonymous (reserved) name used in ACLs and namelists */
#define	ACL_ANONYMOUS_NAME	"Anonymous"
...
#define	MAIL_SAVEDREF_ITEM "$SavedREF"			/* Copy of $REF from original message saved when creating DFR */
...
#define MAIL_DELIVERYSTATUSREPORT_ITEM "DeliveryStatusReport"	/* Delivery Status Notification request item name */
...
#define MAIL_INETORIG_ITEM "$INetOrig"			/* UNID based on hash of MessageID for incoming Internet mail (via SMTP) */
...
#define MAIL_INREPLYTO_ITEM "In_Reply_To"
#define MAIL_REFERENCES_ITEM "References"
...
#define MAIL_GURU_TRACKINGID_ITEM	"DSFTrackingID"
#define MAIL_GURU_FAILURE_ITEM		"DSFFailure"
...
#define MAIL_JOURNALLING_RECIPIENTS_ITEM	"$JournalRecipients"  /* Copy of original Recipients item for journalled message.*/
#define MAIL_JOURNALLING_RECIPS_EXPANDED_PREFIX	"$JournalRecipientsExpanded"  /* Items (ending in _1, _2), which contain Lists of group recipients expanded by the Router for Journalling. */
#define MAIL_JOURNALLING_RECIPS_EXPANDED_FIRST	"$JournalRecipientsExpanded_1"  /* First recipients expanded item */
...
#define IMSG_SMTP_DSN_FROM_ITEM				"SMTPDSNFrom"			/* From address of the delivery status report, typically postmaster@domain.com */
...
#define IMSG_SMTP_DSN_RETRY_UNTIL_ITEM		"SMTPDSNWillRetryUntil"	/* Will-Retry-Until for delayed DSN */
...
#define MAIL_CALENDAR_PROFILE_ADDTZONE_MAIN_CAL			"AdditionalTZMainCal"
#define MAIL_CALENDAR_PROFILE_ADDTZONE_SIDE_CAL			"AdditionalTZSideCal"
#define MAIL_CALENDAR_PROFILE_FOOTER_WEEKNO			    "FooterWeekNo"
#define MAIL_CALENDAR_PROFILE_FOOTER_FIRSTDAY			"FirstDayInYear"
#define MAIL_CALENDAR_PROFILE_FOOTER_MINDAYSINFIRSTWEEK	"MinDaysInFirstWeek"
...
#define MAIL_CS_ST_RECORDMEETING_ITEM              "STRecordMeeting"
...
#define MAIL_CS_NEWSTARTDATETIME_ITEM	"NewStartDateTime"
...
#define MAIL_CS_SCHEDULER_EXPAND_ITEM	"$SchedExpandPublicGroups"
#define MAIL_CS_SCHEDULER_EXPAND_DISABLED	'0'
#define MAIL_CS_SCHEDULER_EXPAND_ENABLED	'1'
...
#define MAIL_CS_NAMEPREFERENCE_ITEM		"NamePreference"	/* NamePreference Item for Alternate Names Support */

//	Defines for .ini settings for time slot preferences.
#define TIMESLOT_START_ITEM		"CalendarTimeSlotStart"
#define TIMESLOT_END_ITEM		"CalendarTimeSlotEnd"
#define TIMESLOT_DURATION_ITEM	"CalendarTimeSlotDuration"
...
#define MAIL_CS_REPEAT_GHOST_CHANGEINSTANCEDATES_ITEM "GhostReschedInstanceDates" /* parallel list with CDT for ghosts */
...
#define MAIL_OUTOFOFFICE_PROFILE "OutOfOfficeProfile"	/* Out of office profile note */
#define MAIL_OUTOFOFFICE_SERVICE_PROFILE "OOServiceProfile"	/* Out of office service profile note */
...
#define MAIL_GROUP_CALENDAR_FORM	"(GroupCalendar)"	/* C&S GroupCalendar form name */
#define MAIL_CHECK_FREETIME_SUBFORM	"(CheckFreetime)"	/* C&S CheckFreetime subform name */
#define MAIL_PERSONALSTATIONARY_FORM		"Personal Stationery"
#define MAIL_REPLY_NOTICE_FORM		"(ReplyNotice)"	/* C&S saved Respond with Comments form */

/* Out of office Service */
#define		OOOPROFILE_DEFINE_PDU						"UserDefineProhibitDesignUpdate"
#define		OOOPROFILE_START_AWAY_ITEM					"dateFirstDayOut"
#define		OOOPROFILE_END_AWAY_ITEM					"dateFirstDayBack"
#define		OOOPROFILE_IGNORE_FROM_LIST_ITEM			"IgnoreFromList"
#define		OOOPROFILE_IGNORE_SEND_LIST_ITEM			"IgnoreSend"
#define		OOOPROFILE_IGNORE_SUBJECT_LIST_ITEM			"IgnoreSubjectPhrase"
#define		OOOPROFILE_NOTIFIED_FIELD_ITEM				"Notified"
#define		OOOPROFILE_EXCLUDE_INTERNET_ITEM			"ExcludeInternetEmail"
#define		OOOPROFILE_GENERAL_MESSAGE_ITEM				"GeneralMessage"
#define		OOOPROFILE_GENERAL_SUBJECT_ITEM				"GeneralSubject"
#define		OOOPROFILE_SPECIAL_MESSAGE_ITEM				"SpecialMessage"
#define		OOOPROFILE_SPECIAL_PEOPLE_LIST_ITEM			"SpecialPeople"
#define		OOOPROFILE_SPECIAL_SUBJECT_ITEM				"SpecialSubject"
#define		OOOPROFILE_NOTIFICATION_CONFIRMATION_ITEM	"NotificationConfirmation"
#define		OOOPROFILE_DAYS_OUT_LINE_ITEM				"DaysOut"
#define		OOOPROFILE_ALT_OWNER_NAME_ITEM				"$AltOwner"
#define		OOOPROFILE_OWNER_LANG_ITEM					"$OwnerLang"
#define		OOOPROFILE_OWNER_NAME_ITEM					"$Owner"
#define		OOOPROFILE_APPEND_SUBJECT					"AppendSubject"
#define		OOOPROFILE_APPEND_SUBJECT_DATE				"AppendSubjectDate"

#define		OOS_PROCESSED_BY_OOS_ITEM					"$OOS"
#define		BLOCKED_SENDER_ITEM							"$Blocked"
#define		MAIL_SENDTO_ITEM							"SendTo"
#define		OOO_PROF_SEQTIME							"$OOOProfSeqTime"
#define		OOO_PROF_SEQNUM								"$OOOProfSeqNum"
...
#define MAIL_EMAIL_1      "email_1"				/* work email 1 */
#define MAIL_EMAIL_5      "email_5"				/* Personal email 2 */
#define MAIL_BIRTHDAY    "Birthday"
#define MAIL_ANNIVERSARY "Anniversary"
#define	MAIL_ITEM_AUTOSUBMITTED "Auto-submitted"	/* indicates if message was auto generated */
#define	MAIL_AUTOGENERATED "auto-generated"			/* value for 	MAIL_ITEM_AUTOSUBMITTED */
#define	MAIL_AUTOREPLIED "auto-replied"				/* value for 	MAIL_ITEM_AUTOSUBMITTED */
#define	MAIL_AUTOFORWARDED "auto-forwarded"			/* value for 	MAIL_ITEM_AUTOSUBMITTED */
#define	MAIL_NOTAUTOREPLIED	"no"					/* value for 	MAIL_ITEM_AUTOSUBMITTED */
...
#define KFM_GETPUB_FIELDS		"Certificate\0Certificate_NoEnc\0PublicKey\0UserCertificate\0$CryptoCap"
#define KFM_GETPUB_NUMFIELDS		4	/* Public key fields only */
#define KFM_GETPUB_NUMFIELDS_EXT	5	/*  plus crypto capabilities */

#define KFM_CRYPTOCAP_ITEM		4		/* 0-based index of crypto cap entry */

#define KFM_GETPUB_CRYPTOCAP	"$CryptoCap"	/* To get just crypto cap field */
...
#define SEC_AUTH_ITEM_DB2_USERNAME				33

#define SEC_AUTH_ITEM_MODIFIED_TIME				34

#define SEC_AUTH_ITEMS_COUNT		 			35
...
/* Address Book - DPAB defines */

#define MAIL_DPAB_GROUP_FORM "DPABgroup"		/* DPAB group form */
#define MAIL_DPAB_PERSON_FORM "DPABperson"		/* DPAB person form */
...
#define MAIL_GEX_NAMELOOKUPITEMCOUNT 6
#define MAIL_GEX_NAMELOOKUPITEMS "FullName\0ListName\0Members\0MailAddress\0$$Readers\0AltFullName"
...
/* DeliveryStatusReport item request items.  Can be concatenated to indicate multiple reports, for example "SF" for 
success and failure reports. If the DeliveryStatusReport item exists, absence of a request letter indicates that 
report is not desired.   */

#define MAIL_DELIVERYSTATUS_REQUEST_NEVER		"N" 	
#define MAIL_DELIVERYSTATUS_REQUEST_SUCCESS		"S"
#define MAIL_DELIVERYSTATUS_REQUEST_FAILURE		"F"
#define MAIL_DELIVERYSTATUS_REQUEST_DELAY		"D"
...
#define HIDDEN_POLICIESEXT_VIEW   	"($PoliciesExt)"
...
#define ADMINDATA_SERVERDB2INSTANCEITEM		13
#define ADMINDATA_SERVERLOOKUPITEMCOUNT	   	14
#define ADMINDATA_SERVERLOOKUPITEMS "Type\0ServerName\0ServerTitle\0Domain\0Network\0ClusterName\0Administrator\0ServerBuildNumber\0ServerPlatform\0SMTPFullHostDomain\0DC_IP_Address\0DC_Port\0DB2AccessServer\0DB2Inst"
...
#define CSLD_CONFIG_DB				"CASConfig.nsf"
...
#define ISPY_TCP_WEBSPHERE_PORT_NUM_LIST		"msg.wpport.number"
#define ISPY_TCP_WEBSPHERE_SEC_ENABLED			"WSSecurity"
#define ISPY_TCP_WEBSPHERE_SOAP_ADDRESS			"soap.conn.address"
#define ISPY_TCP_WEBSPHERE_AUTO_DISCOVER_PORTS 	"Autodiscover"
#define ISPY_TCP_WEBSPHERE_ISC_USERID			"ISCUserID"
#define ISPY_TCP_WEBSPHERE_ISC_PASSWORD			"ISCPassword"
#define ISPY_TCP_WEBSPHERE_SSL_PROPS_FILE		"ssl.client.props"
#define ISPY_TCP_WEBSPHERE_SOAP_PROPS_FILE		"soap.client.props"
#define ISPY_TCP_WEBSPHERE_TARGET_APP_LIST		"TargetWSApp"
...
// Used with mapping probe config docs to probe types in GetProbe()
// Some probe types don't have entries in this list because they use their own version of GetProbe()
...
#define DDM_PROBE_TEXT_WEBSPHERE			"server"
...
#define	DDM_PROBE_SUBTYPE_TEXT_WEBSPHERE 	"websphere services"

// used for DDM WebSphere Probes parsing of ExtraTargetData
#define WAS_TYPE_PORT "port"
#define WAS_TYPE_ERROR "error"
...
#define DDM_ALT_TARGET_SRV	"AltTargetServer"
...
/***
***
** fields for inbox trimming used by adminp
*/
#define ADMINP_CONFIG_INBOX_TRIM_TIME		"InboxTrimTime"		/* time */
#define ADMINP_CONFIG_INBOX_TRIM_DAYS		"InboxTrimDays"		/* text list of day entries */
#define	ADMINP_CONFIG_INBOX_TRIM_LOC		"InboxTrimLoc"		/* indicates where to get the user info */
#define ADMINP_CONFIG_INBOX_TRIM_BY_POLICY	2					/* 1 = from provided list of users */
#define ADMINP_CONFIG_INBOX_TRIM_BY_LIST	1					/* 2 = from policy setting information */
#define ADMINP_CONFIG_INBOX_TRIM_USERS		"InboxTrimUsers"	/* when trim loc is 1 use this list */
#define ADMINP_CONFIG_INBOX_TRIM_GRACE		"gracedays"			/* number of days before inbox item is trimmed */
#define ADMINP_CONFIG_INBOX_TRIM_UNREAD		"SaveUnread"		/* indicates whether unread notes are trimmed */
#define ADMINP_CONFIG_INBOX_TRIM_MAXREMDOCS	"MaxRemDocs"		/* indicates the number of documents to trim */

#define ADMINP_AGENT_CTX_INBOX_TRIM_GRACE		"inboxgracedays"			/* number of days before inbox item is trimmed */

#define	ADMINP_POLICY_INBOX_TRIM_ENABLED	"InboxTrimEnbld"	/* indicates inbox trimming is enabled for this user */
#define	ADMINP_POLICY_INBOX_TRIM_IS_ENABLED	1
/*
** not currently used.
*/
#define ADMINP_CONFIG_INBOX_AGENT_TO	"AdminPAgentTO"			/* time out value for agents */
/*
** 
***
***/
...
/*
** Need to declare the last adminp request so that buffers can be allocated
*/
#define	AdminpLastRequestNumber					180
/*
**
***/
...
#define ADMINP_RECOVERY_INFO_SERVER				"RecoveryServer"
#define ADMINP_RECOVERY_INFO_DATABASE			"RecoveryDatabase"
#define ADMINP_RECOVERY_INFO_RAARAS				"RAARecoveryAuthorities"
#define ADMINP_RECOVERY_INFO_CONFIGADMIN		"ConfigAdministrator"
#define ADMINP_RECOVERY_INFO_RAAENABLED			"RAAEnabled"
...
#define ADMINP_REDIRECT_ITEM					"ProxyDBRedirect"
#define	ADMINP_REDIRECT_SERVER_ITEM				"ProxyDBRedirSrv"
#define	ADMINP_REDIRECT_PATH_ITEM				"ProxyDBRedirPath"
...
#define ADMINP_LOG_RETRY_COUNT_ITEM				"ProxyRetryCount"
//#define ADMINP_LOG_RETRY_REQID_ITEM			"ProxyRequestNoteID"
...
#define	ADMINP_PROXY_SYNC_ALL_UNREAD_ITEM		"ProxySyncUnread"				/* when enabled indicates the user wishes to sync unread tables */
...
/* these below are not job scheduler apps - incorrectly added here */
...
#define ACCOUNT_ORIGSERVERNAME	"OriginalAccountServer"
#define ACCOUNT_ORIGPROTOCOL	"OriginalAccountProtocol"

/* Found these missing names defined in imail\ldap\ldapclco.cpp   
 *  Someone might want to investigate Why that code does NOT use these strings
 */
#define ACCOUNT_SSLLDAPSASL		"SSLLDAPSASL"
#define ACCOUNT_LDAPCHECKNAMES	"LDAPCheckNames"
#define ACCOUNT_LDAPSEARCHBASE	"LDAPSearchBase"
#define ACCOUNT_LDAPSIMPLESEARCH	"LDAPSimpleSearch"
#define ACCOUNT_LDAPMAXENTRIES		LDAP_MAXENTRIES_ITEM
#define ACCOUNT_LDAPTIMEOUT			LDAP_TIMEOUT_ITEM
...
#define INIT_DB2_ITEM_DEFUSER			60
#define INIT_DB2_ITEM_PW_ALARM			61
#define INIT_DB2_ITEM_QVROWS			62

#define INIT_SSO_ITEM_ISITES			63
#define INIT_SSO_ITEM_HTTPSESSIONAUTH	64
#define INIT_SSO_ITEM_HTTPSSOCONFIG		65


#define INIT_SERVERLOOKUPITEMCOUNT		66
...
#define LSBE_IIOP_ENFORCE_ACCESS		8

#define LSBE_SECURITY_ITEM_COUNT		9
#define LSBE_SECURITY_ITEMS			"HTTP_DatabaseBrowsing\0HTTP_AuthView\0\
IIOP_TCPNP\0IIOP_AllowAnonymous\0\
IIOP_SSLNP\0IIOP_SSLAnonymous\0HTTP_enableSessionAuth\0HTTP_SSOCfg\0IIOP_EnforceAccess"
...
#define LTPA_WSTOKENNAME2			"LtpaToken2"

#define LTPA_TOKENNAME				"Ltpa_TokenName"
#define LTPA_TOKENFORMAT			"Token_Format"
...
/* 	Search Bar queries */
#define QUERY_V8_WEBSYNTAX_ITEM		"$V8WebQueryObject"	/* Query object that a user with web-syntax saved */
...
#define AUTO_FORWARD			"$AutoForward"	/* auto forwarded mail */
...
#ifdef DO_ONFOCUS
#define VIEW_ACTION_EVENT_COUNT	17	/* ie, $ViewAction0-$ViewActionN - one per view script event that can contain formulas */
#else
#define VIEW_ACTION_EVENT_COUNT	15	/* ie, $ViewAction0-$ViewActionN - one per view script event that can contain formulas */
#endif
...
#define WEBSERVICE_FLAG_VALIDATESVCREQ	'A'	/*LI 3927.02 WS Design Element Enhancement*/
...
#define DEFAULT_COMPAPP_PAGE_ITEM "$DefaultCompAppPage"
#define DEFAULT_COMPAPP_ITEM "$DefaultCompApp"
...
/* icon flags */
/* used values: aAbBcCdDeEFfgGhHiIjJKklLmMnoOpPQrsStTuUvVWwxXyzZ123456789 */
...
#define CHFLAG_OOS_ENABLED				'O'	/* icon flag flagigng if out of office service is enabled DBOPTBIT_OOS_ENABLED */

#define CHFLAG_SUPPORT_RESP_THREADS		'H' /* icon flag marking that the database supports reponse threads */
#define CHFLAG_THEMES					'I' /* enable themes in this database */

#define CHFLAG_COMPRESSED_DESIGN		'q' /* compress design documents */
#define CHFLAG_COMPRESSED_DATA_DOCS		'N' /* compress data documents */
...
#define	ITEM_NAME_NOTE_SEAL2 "$Seal2"
...
/* IDs for Notes Contributed Preference Pages (reparented Pref Dialog)*/
#define BASIC_PREF_HELP "MODELESSDIALOG 2080 "
#define TOOLBAR_PREF_HELP "MODELESSDIALOG 488 "
#define REPLICATION_PREF_HELP "MODELESSDIALOG 2075 "
...
#define LOG_DUMP_NOTE_START			"<Dump Note Start>"
#define LOG_DUMP_NOTE_END			"<Dump Note End>"
...
#define WKSXML_BACKGROUND_QUEUE_NAME	TASK_QUEUE_PREFIX"WksBkgnd"
...
#define LOCATION_ADMIN_MONITOR_AUTOACTIVATE_LIVECONSOLE		"AutoActivateLiveConsole"
...
#define FOLDER_SEARCHVIEW		"($Search)"
...
#define FOLDER_CONTACTS_LIST_ALIAS	"PeopleDisplay"
...
/* Says that all items on this form should be activated in place
	even if we are in WCT and the default is off */
#define OLE_ITEM_INPLACE				"$OLEInPlaceAll"
...
/* Embedded Email Browser */
#define EMBEDDED_WEBBROWSER4_FORM		"EmbeddedBrowser4Form"		/* Can be embedded as body if IE 4 is installed */
#define EMBEDDED_WEBBROWSER_FORM_ITEM	"$BrowserRender"	/* If on form/note and the data is right, we'll render using a browser */	

/* Delayed Remote Images */
#define MIME_DELAYED_IMAGES_PRESENT		"$DelayedImages"
#define MIME_DELAYED_IMAGES_OK			"$DelayedImagesOK"
...
/*  And by Contacts */
#define MAIL_FRAMESET_CONTACTS		"Contacts"
...
/* default XML and namespace declaration for Domino server console XML */
#define	CONSOLE_XML_DECLARATION	"<?xml version=\"1.0\" encoding=\"UTF-8\" ?>"
#define	CONSOLE_XML_NAMESPACE	"http://www.lotus.com/dxl/console"
