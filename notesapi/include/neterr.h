...
#define ERR_NO_DDM_NAMES_MOD			PKG_NETWORK+93
	errortext(ERR_NO_DDM_NAMES_MOD,		"The DDM names have not been modified since the time specified")
...
#define ERR_MAIL_PROBE_SLOW			PKG_NETWORK+108
	errortext(ERR_MAIL_PROBE_SLOW, 	"Mail probe to %s was successful, but slow")
...
#define ERR_NETBFR_POOLFULL			PKG_NETWORK+129
	errortext(ERR_NETBFR_POOLFULL,	"Insufficient memory - NetBfr Pool is full.")
...
#define ERR_SESSION_POOLFULL		PKG_NETWORK+142
	errortext(ERR_SESSION_POOLFULL,		"Insufficient memory - Session Pool is full.")
...
#define ERR_ISPY_PROBE_COMPLETED		PKG_NETWORK+169
	errortext(ERR_ISPY_PROBE_COMPLETED,	"Probe of %s port%s on %s has completed") //there is no " " between 't' & '%' for a reason
...
#define ERR_MAIL_PROBE_NO_RECIPIENT		PKG_NETWORK+234
	errortext(ERR_MAIL_PROBE_NO_RECIPIENT, "Mail probe configuration does not specify a recipient")
...
#define STR_HOMENET_LOCATIONNAME		  			PKG_NETWORK+244
	stringtext(STR_HOMENET_LOCATIONNAME,  			"Home")
...
#define STR_SERVERNAME_MISMATCH						PKG_NETWORK+253
	stringtext(STR_SERVERNAME_MISMATCH,				"Configuration Error: Server record not found. The Server Name in ID file [%s], does not match any Server found in the Domino Directory. Check that the Server name field in the Server record is a hierarchical name.")
...
#define ERR_TASK_DESC_LOGPURGE						(PKG_NETWORK2+2)
	stringtext(ERR_TASK_DESC_LOGPURGE, 				"Log Purge Task is active|Log Purge Task is idle")
...
#define ERR_ISPY_PROBE_WEBSPHERE_TIMEOUT			PKG_NETWORK2+9
	errortext(ERR_ISPY_PROBE_WEBSPHERE_TIMEOUT,		"Probe of WebSphere Services for %s %s on %s, has timed out")
...
#define STR_LAN_LOCATIONNAME						PKG_NETWORK2+11
	stringtext(STR_LAN_LOCATIONNAME,				"Online")
#define STR_TRAVEL_LOCATIONNAME						PKG_NETWORK2+12
	stringtext(STR_TRAVEL_LOCATIONNAME,				"Travel")
#define STR_NONE_LOCATIONNAME						PKG_NETWORK2+13
	stringtext(STR_NONE_LOCATIONNAME,				"Offline")
...
#define STR_PROTOCOL_REMOVED						PKG_NETWORK2+70
	stringtext(STR_PROTOCOL_REMOVED,				" [Obsolete protocol removed by Domino]")
...
#define ERR_ISPY_PROBE_WEBSPHERE_APP_STOPPED		PKG_NETWORK2+84
	errortext(ERR_ISPY_PROBE_WEBSPHERE_APP_STOPPED,	"Probe of WebSphere Services: Application %s is stopped on %s.")

#define ERR_LOG_NOTE_LIMIT							PKG_NETWORK2+85
	errortext(ERR_LOG_NOTE_LIMIT,					"Log note has exceeded size limits.")
...
#define STR_DB_DIRLINK_RQST_LIST					PKG_NETWORK2+94
	stringtext(STR_DB_DIRLINK_RQST_LIST,			"DB_DIRLINK_SET|DB_DIRLINK_GET")
#define IDX_STR_DIRLINK_SET_RQST		1
#define IDX_STR_DIRLINK_GET_RQST		2
	
#define STR_REDIRECT_RQST_LIST						PKG_NETWORK2+95
	stringtext(STR_REDIRECT_RQST_LIST,				"DB_REDIRECT_SET|DB_REDIRECT_GET")
#define IDX_STR_REDIRECT_SET_RQST		1
#define IDX_STR_REDIRECT_GET_RQST		2
...
#define ERR_LDAPACCESSGROUPS_CONFLICT				(PKG_NETWORK2+99)
	errortext(ERR_LDAPACCESSGROUPS_CONFLICT,		"A $$LDAPAccessGroups-returned group already appears in the names list")
...
#define STR_RQST4_LIST							(PKG_NETWORK3+2)
	stringtext(STR_RQST4_LIST,		 			"GETNOTES_RQST|GETOBJECT_RQST|DB_IMAP_FETCHNOTES_RQST|DB_ARCHIVE_DELETE_NOTES_RQST|DB_PRUNE_NOTES_RQST|DB_MAJMIN_RQST|SERVER_ACL_RQST|GET_POLICY_RQST")
...
#define IDX_STR_GET_POLICY_RQST			8
...
#define STR_GET_SSO_TOKENLIST_RQST					PKG_NETWORK3+22
	stringtext(STR_GET_SSO_TOKENLIST_RQST,			"GET_SSO_TOKENLIST_RQST")
...
#define STR_NAMED_OBJECT_ENUM_RQST	PKG_NETWORK3+24
	stringtext(STR_NAMED_OBJECT_ENUM_RQST,"GET_NAMED_OBJECTS")
...
#define ERR_ALHT_BPOOL_FULL						(PKG_NETWORK3+27)
	errortext(ERR_ALHT_BPOOL_FULL,				"Array List Hashtable (ALHT) BPool Full")
...
#define STR_RQST1A_LIST							(PKG_NETWORK4+14)	
	stringtext(STR_RQST1A_LIST,					"GET_IOR_RQST|DB2_GETINFO_RQST|DB2_GETSVINFO_RQST|DB2_CONT_RQST|DB2_ENABLE_RQST")
#define IDX_STR_GET_IOR_RQST				1
#define IDX_STR_DB2_GETINFO_RQST			2
#define IDX_STR_DB2_GETSVINFO_RQST			3
#define IDX_STR_DB2_CONT_RQST				4
#define IDX_STR_DB2_ENABLE_RQST				5

#define STR_RQST5_LIST							(PKG_NETWORK4+15)
	stringtext(STR_RQST5_LIST,		 			"GET_MODFOLDERS_RQST|GET_ALLFOLDERCHANGES_RQST|SCHED_GET_PRIVATE_ENTRIES|NAME_LOOKUP_EXTENDED_RQST|STAMP_NOTES_MULTIITEM|ISDB2_RQST|DB2_ACTION_RQST")
...
#define IDX_STR_STAMP_NOTES_MULTIITEM		5
#define IDX_STR_ISDB2_RQST					6
#define IDX_STR_DB2_ACTION_RQST				7
...
#define STR_GET_COLLATION_RQST				(PKG_NETWORK5+16)
	stringtext(STR_GET_COLLATION_RQST,		"GET_COLLATION")
...
#define STR_SCHED_ADD_BTCACHE_RQST				(PKG_NETWORK5+27)
	stringtext(STR_SCHED_ADD_BTCACHE_RQST,		"SCHED_ADD_BTCACHE_RQST")
#define STR_SCHED_GET_BTCACHE_RQST				(PKG_NETWORK5+28)
	stringtext(STR_SCHED_GET_BTCACHE_RQST,		"SCHED_GET_BTCACHE_RQST")

/* #define STR_GET_SUG_RQST					(PKG_NETWORK5+29)
	stringtext(STR_GET_SUG_RQST,					"GET_SUG_RQST") */

#define STR_RQST1C_LIST						(PKG_NETWORK5+29)
	stringtext(STR_RQST1C_LIST,				"GET_SUG_RQST|SERVER_GET_DB2_STATUS|NIF_COLLECTION_CURRENT_RQST|IDX_STR_DB2_UDF_CONN_RQST|GET_MODIFIED_UNREADS_RQST")
#define IDX_STR_GET_SUG_RQST	1
#define IDX_STR_SERVER_GET_DB2_STATUS 2	
#define IDX_STR_NIF_COLLECTION_CURRENT_RQST 3
#define IDX_STR_DB2_UDF_CONN_RQST	4
#define IDX_STR_GET_MOD_UNREAD_RQST	5
/* #define STR_SCR_RQST						(PKG_NETWORK5+30)
	stringtext(STR_SCR_RQST,				"SCR_RQST")  		*/


#define STR_RQST1B_LIST						(PKG_NETWORK5+30)
	stringtext(STR_RQST1B_LIST,				"SCR_RQST|DB2_RELOCATE_CONT_RQST|DB2_UDF_NOTE_UPDATE_RQST|GETSET_FOLDERINFO_RQST|ID_EXTRA_RQST|JS_GETSCHED_RQST|LOG_SEARCHR6_MSG_RQST|GETCHANGEDDBS_RQST|DB_MODIFIEDTIME_BYNAME_RQST|GET_DB_MODIFIED_NOTES_INFO_RQST|GETDBCHANGES_RQST")

#define IDX_STR_SCR_RQST					1
#define	IDX_STR_DB2_RELOCATE_CONT_RQST		2
#define IDX_STR_DB2_UDF_NOTE_UPDATE_RQST	3
#define	IDX_STR_GETSET_FOLDERINFO_RQST		4	
#define	IDX_STR_ID_EXTRA_RQST				5
#define	IDX_STR_JS_GETSCHED_RQST			6
#define IDX_STR_LOG_SEARCHR6_MSG_RQST		7
#define IDX_STR_GETCHANGEDBS_RQST			8
#define	IDX_STR_DBMODIFIEDTIMEBYNAME_RQST	9
#define IDX_STR_GET_DB_MODIFIED_NOTES_INFO_RQST	10
#define IDX_STR_GETDBCHANGES_RQST			11

#define ERR_MAIL_PROBE_FAILURE				PKG_NETWORK5+31
	errortext(ERR_MAIL_PROBE_FAILURE,		"Mail probe to %s has failed. %s")
