...
#define PKG_XPM_ERR		0x0B40		/* Codes are limited to 0 - 63 */
...
#define PKG_MAILMAN		0x1150		/* Errors returned by MAILMAN, 0 - 31 */
#define PKG_ROUTER2		0x1170		/* Errors returned by ROUTERL, 0 - 47 */
...
#define PKG_SMTPC2		0x3C80		/* SMTP server and client. 0-7 */
