...
#define NOTEID_GHOST_ENTRY		0x40000000L /* Bit 30 -> partial thread ghost collection entry */
...
STATUS LNPUBLIC		NIFReadEntries (HCOLLECTION hCollection, COLLECTIONPOSITION far *IndexPos,
									...
									DWORD ReturnMask,
									DHANDLE far *rethBuffer, WORD far *retBufferLength,
