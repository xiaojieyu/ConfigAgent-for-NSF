...
#define VIEW_COLUMN_FORMAT_SIGNATURE6	0x4361 /* LI 3548.38, Vertical Layout */
...
#define VIEW_TABLE_SHOW_PARITAL_THREADS		0x0020	/* TRUE if view supports display of partial thread hierarchy (Hannover v8)*/
#define VIEW_TABLE_FLAG_PARTIAL_FLATINDEX	0x0020	/* LI 3548.57 show partial index hierarchically, if TRUE */
	} VIEW_TABLE_FORMAT;
...
#define VTF3_S_ShowVerticalHorizontalSwitcher	11
#define VTF3_M_ShowVerticalHorizontalSwitcher	0x00000800	/* Hannover */
#define VTF3_S_ShowTabNavigator					12
#define VTF3_M_ShowTabNavigator					0x00001000	/* Hannover Java Views */
#define VTF3_S_AllowThreadGathering			13
#define VTF3_M_AllowThreadGathering			0x00002000	/* Hannover Java Views  */
#define VTF3_S_DisableHideJaveView			14
#define VTF3_M_DisableHideJaveView			0x00004000	/* Hannover Java Views  */
/* unused 15 & 0x00008000	was whether to publish a property on view select in composite app */
#define VTF3_S_HideColumnHeader				16
#define VTF3_M_HideColumnHeader				0x00010000	/* Hannover */
	...
	WORD  wThemeSetting;					/*	V8 Theme setting */		
...
#define VCF3_S_ExtendedColFmt6				15	/* LI 3548.38, Vertical. Column has extended names format */
#define VCF3_M_ExtendedViewColFmt6			0x8000
