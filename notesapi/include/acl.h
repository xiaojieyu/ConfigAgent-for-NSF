...
STATUS LNPUBLIC ACLLookupAccess (DHANDLE hACL,
...
STATUS LNPUBLIC ACLCreate (DHANDLE far *rethACL);
STATUS LNPUBLIC ACLAddEntry (DHANDLE hACL,
								const char far *Name,
								WORD AccessLevel,
								ACL_PRIVILEGES far *Privileges,
								WORD AccessFlags);
STATUS LNPUBLIC ACLDeleteEntry (DHANDLE hACL,
								const char far *Name);
STATUS LNPUBLIC ACLUpdateEntry (DHANDLE hACL,
								const char far *Name,
								WORD UpdateFlags,
								...
								WORD NewAccessFlags);
STATUS LNPUBLIC ACLEnumEntries (DHANDLE hACL,
...
STATUS LNPUBLIC ACLGetPrivName (DHANDLE hACL,
								WORD PrivNum,
								char far *retPrivName);
STATUS LNPUBLIC ACLSetPrivName (DHANDLE hACL,
								WORD PrivNum,
								char far *PrivName);

STATUS LNPUBLIC ACLGetHistory (DHANDLE hACL, DHANDLE far *hHistory, WORD far *HistoryCount);
STATUS LNPUBLIC ACLGetFlags (DHANDLE hACL, DWORD far *Flags);
STATUS LNPUBLIC ACLSetFlags (DHANDLE hACL, DWORD Flags);
STATUS LNPUBLIC ACLGetAdminServer (DHANDLE hList, char far *ServerName);
STATUS LNPUBLIC ACLSetAdminServer (DHANDLE hList, char far *ServerName);
