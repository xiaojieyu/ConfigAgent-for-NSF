...
typedef struct {
	...
	*		UNID of additional information (i.e. view in frameset) if 
	*					CDRESOURCE_FLAGS_UNIDADDED flag is set
	*/
} CDRESOURCE;
...
#define CDRESOURCE_FLAGS_PREVIEW			0x00000400	/* open this up in preivew mode, if supported.   Not saved to disk */
#define CDRESOURCE_FLAGS_SEARCH				0x00000800	/* we will be doing a search after link opened.   Not saved to disk */

#define CDRESOURCE_FLAGS_UNIDADDED			0x00001000	/* An UNID is added to the end of the hResource that means 
