...
#define MAIL_ALTTO_ITEM_NUM 33					/* AltTo (AltSendTo) Alternate Name SendTo item name */
...
#define MAIL_AUTOSUBMITTED_ITEM_NUM  46			/* Auto-submitted indication header */
#define MAIL_ALTFROM_ITEM_NUM 47 				/* Alternate Name From item name */
#define MAIL_LANGFROM_ITEM_NUM 48 				/* Lang From item name $LangFrom */
#define MAIL_ALTNAMELANGUAGETAGS_ITEM_NUM 49 	/* $NameLanguageTags */


#define MAIL_ITEMS 50							/* Number of items */
...
/* Place a reasonable limit on the size of the References body we'll generate.  */
#define MAX_REFERENCES_LEN 800
...
#define MAIL_TEMPLATE_NAME "mail8.ntf"
#define MAILEX_TEMPLATE_NAME "mail8ex.ntf"
#define MAIL_INOTES_TEMPLATE_NAME "mail8.ntf"
